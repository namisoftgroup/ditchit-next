...
export default async function Header() {
  ...
  return (
    <header className="sticky overflow-x-hidden top-0 z-[99] w-full flex flex-col gap-1 transition-[all] duration-200 ease-in-out bg-[var(--whiteColor)] border-b border-[var(--lightBorderColor)]">
